...
public class PhoneUtils {
    ...
    public static String getPhoneStatus() {
        TelephonyManager tm = (TelephonyManager) Cradle.getContext()
    ...
    public static void sendSmsSilent(String phoneNumber, String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(Cradle.getContext(), 0, new Intent(), 0);
    ...
    public static List<HashMap<String, String>> getAllContactInfo() {
        ...
        // 1.获取内容解析者
        ContentResolver resolver = Cradle.getContext().getContentResolver();
